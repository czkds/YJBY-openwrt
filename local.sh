...
function op_diywenjian() {
  ...
  if [[ ! -d ${GITHUB_WORKSPACE}/OP_DIY ]]; then
    rm -rf bendi && git clone https://github.com/czkds/openwrt bendi
    ...
    if [[ -d ${GITHUB_WORKSPACE}/OP_DIY ]]; then
      rm -rf bendi && git clone https://github.com/czkds/common bendi
      judge  "OP_DIY文件下载"
...
function op_jiaoben() {
  ...
  rm -rf ${HOME_PATH}/build/common && git clone https://github.com/czkds/common ${HOME_PATH}/build/common
  judge "额外扩展文件下载"
